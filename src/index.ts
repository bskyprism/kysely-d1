...
/**
 * Config for the D1 dialect. Pass your D1 instance to this object that you
 ...
 * The constructor takes the instance of your D1 database that you bound
 * in `wrangler.toml`.
 *
 * ```ts
 * new D1Dialect({
...
class D1Connection implements DatabaseConnection {
    ...
    async executeQuery<O> (compiledQuery: CompiledQuery): Promise<QueryResult<O>> {
        ...
        ) ? undefined : BigInt(results.meta.last_row_id))
